...
if(alertMsg)alertMsg.error(json.message||DWZ.msg("forbidden"));}else{
...
$input.val(ivalue+istep);}}else if(type==-1){
if(ivalue>=istart+istep){
$input.val(ivalue-istep);}}else if(ivalue>iend){
...
if(ml>9){
monthlist+='<dd class="'+_ctrClass+'" chMonth="'+(ml-dw.month)+'" day="1" style="width:88px;float:left">'+dw.year+'-'+ml+'</dd>';}else{
