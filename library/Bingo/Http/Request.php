...
class Bingo_Http_Request
{
     ...
     */
    protected static $_strHttpEncode = 'GBK'/*UTF8DIFF*/;
    /**
     * 内部代码编码方式
     *
     * @var string:utf-8/gbk
     */
    protected static $_strInternalEncode = 'GBK'/*UTF8DIFF*/;
    /**
    ...
    {
        $value = is_array($value) ? array_map(array('Bingo_Http_Request', '_stripslashesDeep'), $value) : stripcslashes($value);
        return $value;
    }
    /**
     * 检测HTTP的编码方式
