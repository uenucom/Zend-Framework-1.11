...
class Custom_Controller_Plugin_Myotherpager implements Zend_Paginator_Adapter_Interface {

    public function __construct($dataresult, $numsql, $offset, $itemCountPerPage) {
