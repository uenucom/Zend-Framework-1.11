...
class thrift_UnionForumColumnNodeElements {
  ...
  public function write($output) {
    ...
    if ($this->unionName !== null) {
      $xfer += $output->writeFieldBegin('unionName', TType::STRING, 2);
...
class thrift_UnionThreadElementsList {
  ...
  public function write($output) {
    ...
    if ($this->unionName !== null) {
      $xfer += $output->writeFieldBegin('unionName', TType::STRING, 8);
      $xfer += $output->writeString($this->unionName);
      $xfer += $output->writeFieldEnd();
    }
...
class thrift_UnionThreadTopic {
  ...
  public function write($output) {
    ...
    if ($this->unionName !== null) {
      $xfer += $output->writeFieldBegin('unionName', TType::STRING, 12);
      $xfer += $output->writeString($this->unionName);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->userId !== null) {
