...
class weibo_ContentElement {
  ...
  public function write($output) {
    ...
    if ($this->refisVisible !== null) {
      $xfer += $output->writeFieldBegin('refisVisible', TType::I32, 11);
      $xfer += $output->writeI32($this->refisVisible);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->refTid !== null) {
      $xfer += $output->writeFieldBegin('refTid', TType::STRING, 12);
    ...
    if ($this->refUserId !== null) {
      $xfer += $output->writeFieldBegin('refUserId', TType::I32, 14);
      $xfer += $output->writeI32($this->refUserId);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->refNickName !== null) {
      $xfer += $output->writeFieldBegin('refNickName', TType::STRING, 15);
      $xfer += $output->writeString($this->refNickName);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->refReplyNum !== null) {
      $xfer += $output->writeFieldBegin('refReplyNum', TType::I32, 16);
      $xfer += $output->writeI32($this->refReplyNum);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->refForwardNum !== null) {
      $xfer += $output->writeFieldBegin('refForwardNum', TType::I32, 17);
      $xfer += $output->writeI32($this->refForwardNum);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->refCreateTime !== null) {
      $xfer += $output->writeFieldBegin('refCreateTime', TType::STRING, 18);
      $xfer += $output->writeString($this->refCreateTime);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->refRealDesc !== null) {
      $xfer += $output->writeFieldBegin('refRealDesc', TType::STRING, 19);
      $xfer += $output->writeString($this->refRealDesc);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->smallpic !== null) {
      $xfer += $output->writeFieldBegin('smallpic', TType::STRING, 20);
      $xfer += $output->writeString($this->smallpic);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->bigpic !== null) {
      $xfer += $output->writeFieldBegin('bigpic', TType::STRING, 21);
      $xfer += $output->writeString($this->bigpic);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->refSource !== null) {
      $xfer += $output->writeFieldBegin('refSource', TType::I32, 22);
