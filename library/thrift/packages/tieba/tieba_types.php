...
class thrift_ForumColumnNodeElements {
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['postCount'])) {
        $this->postCount = $vals['postCount'];
      }
      if (isset($vals['replyCount'])) {
        $this->replyCount = $vals['replyCount'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 11:
          if ($ftype == TType::I32) {
            $xfer += $input->readI32($this->postCount);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->postCount !== null) {
      $xfer += $output->writeFieldBegin('postCount', TType::I32, 11);
      $xfer += $output->writeI32($this->postCount);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->replyCount !== null) {
      $xfer += $output->writeFieldBegin('replyCount', TType::I32, 12);
      $xfer += $output->writeI32($this->replyCount);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
...
class thrift_ForumElementsList {
  ...
  public function write($output) {
    ...
    if ($this->postCount !== null) {
      $xfer += $output->writeFieldBegin('postCount', TType::I32, 3);
      $xfer += $output->writeI32($this->postCount);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->forumDesc !== null) {
      $xfer += $output->writeFieldBegin('forumDesc', TType::STRING, 4);
      $xfer += $output->writeString($this->forumDesc);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->replyCount !== null) {
      $xfer += $output->writeFieldBegin('replyCount', TType::I32, 5);
      $xfer += $output->writeI32($this->replyCount);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
...
class thrift_FormuThreadElementsList {
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['threadContent'])) {
        $this->threadContent = $vals['threadContent'];
      }
    }
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 18:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->threadContent);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->summary !== null) {
      $xfer += $output->writeFieldBegin('summary', TType::STRING, 16);
    ...
    if ($this->pics !== null) {
      ...
      $xfer += $output->writeFieldBegin('pics', TType::LST, 17);
      {
        $output->writeListBegin(TType::STRING, count($this->pics));
        {
          foreach ($this->pics as $iter34)
          {
    ...
    if ($this->threadContent !== null) {
      $xfer += $output->writeFieldBegin('threadContent', TType::STRING, 18);
      $xfer += $output->writeString($this->threadContent);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
...
class thrift_ThreadContentElementsList {
  ...
  public $replyUserPhoto = null;
  public $referUserPhoto = null;
  public $upNum = null;
  public $isTop = null;
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['replyUserPhoto'])) {
        $this->replyUserPhoto = $vals['replyUserPhoto'];
      }
      if (isset($vals['referUserPhoto'])) {
        $this->referUserPhoto = $vals['referUserPhoto'];
      }
      if (isset($vals['upNum'])) {
        $this->upNum = $vals['upNum'];
      }
      if (isset($vals['isTop'])) {
        $this->isTop = $vals['isTop'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 16:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->replyUserPhoto);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 17:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->referUserPhoto);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->replyUserPhoto !== null) {
      $xfer += $output->writeFieldBegin('replyUserPhoto', TType::STRING, 16);
      $xfer += $output->writeString($this->replyUserPhoto);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->referUserPhoto !== null) {
      $xfer += $output->writeFieldBegin('referUserPhoto', TType::STRING, 17);
      $xfer += $output->writeString($this->referUserPhoto);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->upNum !== null) {
      $xfer += $output->writeFieldBegin('upNum', TType::I32, 18);
      $xfer += $output->writeI32($this->upNum);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->isTop !== null) {
      $xfer += $output->writeFieldBegin('isTop', TType::I32, 19);
      $xfer += $output->writeI32($this->isTop);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem40 = null;
              $elem40 = new thrift_VoteContentElementsList();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem47 = null;
              $elem47 = new thrift_FormuThreadElementsList();
...
class thrift_ThreadContentElements {
      ...
      switch ($fid)
      {
        ...
        case 11:
          if ($ftype == TType::LST) {
            ...
            {
              $elem54 = null;
              $elem54 = new thrift_ThreadContentElementsList();
  ...
  public function write($output) {
    ...
    if ($this->photo !== null) {
      $xfer += $output->writeFieldBegin('photo', TType::STRING, 16);
      $xfer += $output->writeString($this->photo);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->up !== null) {
      $xfer += $output->writeFieldBegin('up', TType::I32, 17);
      $xfer += $output->writeI32($this->up);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->down !== null) {
      $xfer += $output->writeFieldBegin('down', TType::I32, 18);
      $xfer += $output->writeI32($this->down);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem61 = null;
              $elem61 = new thrift_ThreadElementsList();
...
class thrift_ThreadOnlyLookLandList {
  ...
  public function write($output) {
    ...
    if ($this->replyUserPhoto !== null) {
      $xfer += $output->writeFieldBegin('replyUserPhoto', TType::STRING, 11);
      $xfer += $output->writeString($this->replyUserPhoto);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->upNum !== null) {
      $xfer += $output->writeFieldBegin('upNum', TType::I32, 12);
      $xfer += $output->writeI32($this->upNum);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->isTop !== null) {
      $xfer += $output->writeFieldBegin('isTop', TType::I32, 13);
      $xfer += $output->writeI32($this->isTop);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
...
class thrift_ThreadOnlyLookLand {
      ...
      switch ($fid)
      {
        ...
        case 8:
          if ($ftype == TType::LST) {
            ...
            {
              $elem68 = null;
              $elem68 = new thrift_ThreadOnlyLookLandList();
  ...
  public function write($output) {
    ...
    if ($this->photo !== null) {
      $xfer += $output->writeFieldBegin('photo', TType::STRING, 17);
      $xfer += $output->writeString($this->photo);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem96 = null;
              $elem96 = new thrift_HotForumElementsList();
              $xfer += $elem96->read($input);
              $this->hotForumElementsList []= $elem96;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->hotForumElementsList !== null) {
      ...
      $xfer += $output->writeFieldBegin('hotForumElementsList', TType::LST, 1);
      {
        ...
        {
          foreach ($this->hotForumElementsList as $iter97)
          {
...
class thrift_SpeThreadElementsList {
  ...
  public function write($output) {
    ...
    if ($this->photo !== null) {
      $xfer += $output->writeFieldBegin('photo', TType::STRING, 18);
      $xfer += $output->writeString($this->photo);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->summary !== null) {
      $xfer += $output->writeFieldBegin('summary', TType::STRING, 19);
      $xfer += $output->writeString($this->summary);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->pics !== null) {
      ...
      $xfer += $output->writeFieldBegin('pics', TType::LST, 20);
      {
        $output->writeListBegin(TType::STRING, count($this->pics));
        {
          foreach ($this->pics as $iter104)
          {
    ...
    if ($this->up !== null) {
      $xfer += $output->writeFieldBegin('up', TType::I32, 21);
      $xfer += $output->writeI32($this->up);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->down !== null) {
      $xfer += $output->writeFieldBegin('down', TType::I32, 22);
      $xfer += $output->writeI32($this->down);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem110 = null;
              $elem110 = new thrift_SpeThreadElementsList();
              $xfer += $elem110->read($input);
              $this->speThreadElementsList []= $elem110;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->speThreadElementsList !== null) {
      ...
      $xfer += $output->writeFieldBegin('speThreadElementsList', TType::LST, 1);
      {
        ...
        {
          foreach ($this->speThreadElementsList as $iter111)
          {
...
class thrift_Html5ThreadElements {
  ...
  public function write($output) {
    ...
    if ($this->summary !== null) {
      $xfer += $output->writeFieldBegin('summary', TType::STRING, 7);
      $xfer += $output->writeString($this->summary);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->pics !== null) {
      ...
      $xfer += $output->writeFieldBegin('pics', TType::LST, 8);
      {
        $output->writeListBegin(TType::STRING, count($this->pics));
        {
          foreach ($this->pics as $iter118)
          {
    ...
    if ($this->up !== null) {
      $xfer += $output->writeFieldBegin('up', TType::I32, 9);
      $xfer += $output->writeI32($this->up);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->down !== null) {
      $xfer += $output->writeFieldBegin('down', TType::I32, 10);
      $xfer += $output->writeI32($this->down);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
...
class thrift_ThreadPostElements {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem124 = null;
              $elem124 = new thrift_ThreadContentElementsList();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ThreadPostElements');
    if ($this->count !== null) {
      $xfer += $output->writeFieldBegin('count', TType::I32, 1);
      $xfer += $output->writeI32($this->count);
      $xfer += $output->writeFieldEnd();
    ...
    if ($this->posts !== null) {
      ...
      $xfer += $output->writeFieldBegin('posts', TType::LST, 2);
      {
        $output->writeListBegin(TType::STRUCT, count($this->posts));
        {
          foreach ($this->posts as $iter125)
          {
...
class thrift_ThreadSimple {
      ...
      switch ($fid)
      {
        ...
        case 7:
          if ($ftype == TType::LST) {
            ...
            {
              $elem131 = null;
              $elem131 = new thrift_ThreadContentElementsList();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ThreadSimple');
    if ($this->threadId !== null) {
      $xfer += $output->writeFieldBegin('threadId', TType::STRING, 1);
      $xfer += $output->writeString($this->threadId);
      $xfer += $output->writeFieldEnd();
    ...
    if ($this->forumName !== null) {
      $xfer += $output->writeFieldBegin('forumName', TType::STRING, 4);
      $xfer += $output->writeString($this->forumName);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->up !== null) {
      $xfer += $output->writeFieldBegin('up', TType::I32, 5);
      $xfer += $output->writeI32($this->up);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->down !== null) {
      $xfer += $output->writeFieldBegin('down', TType::I32, 6);
      $xfer += $output->writeI32($this->down);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->replys !== null) {
      if (!is_array($this->replys)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('replys', TType::LST, 7);
      {
        $output->writeListBegin(TType::STRUCT, count($this->replys));
        {
          foreach ($this->replys as $iter132)
          {
...
class thrift_ThreadSimpleHotPic {
  ...
  public $threadSimple = null;
  public $picList = null;
  public $threadSimpleList = null;
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      if (isset($vals['threadSimple'])) {
        $this->threadSimple = $vals['threadSimple'];
      }
      if (isset($vals['picList'])) {
        $this->picList = $vals['picList'];
      }
      if (isset($vals['threadSimpleList'])) {
        $this->threadSimpleList = $vals['threadSimpleList'];
      }
    }
  }

  public function getName() {
    return 'ThreadSimpleHotPic';
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->threadSimple = new thrift_ThreadSimple();
            $xfer += $this->threadSimple->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem144 = null;
              $elem144 = new thrift_ThreadSimple();
              $xfer += $elem144->read($input);
              $this->threadSimpleList []= $elem144;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ThreadSimpleHotPic');
    if ($this->threadSimple !== null) {
      if (!is_object($this->threadSimple)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('threadSimple', TType::STRUCT, 1);
      $xfer += $this->threadSimple->write($output);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->picList !== null) {
      ...
      $xfer += $output->writeFieldBegin('picList', TType::LST, 2);
      {
        $output->writeListBegin(TType::STRING, count($this->picList));
        {
          foreach ($this->picList as $iter145)
          {
    ...
    if ($this->threadSimpleList !== null) {
      if (!is_array($this->threadSimpleList)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('threadSimpleList', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRUCT, count($this->threadSimpleList));
        {
          foreach ($this->threadSimpleList as $iter146)
          {
